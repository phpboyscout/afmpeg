...
rt, err := afmpeg.New(ctx, afmpeg.WithModuleURL(
    "https://gitlab.com/api/v4/projects/83847809/packages/generic/ffmpeg-wasi/n8.1.2-11/ffmpeg-wasi-lgpl.wasm",
...
- **[ffmpeg-wasi](https://ffmpeg-wasi.phpboyscout.uk)** *(the route)* — the companion
  ...
  [`n8.1.2-11`](https://gitlab.com/phpboyscout/ffmpeg-wasi/-/releases/n8.1.2-11)). It speaks the
