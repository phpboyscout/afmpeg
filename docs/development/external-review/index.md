...
| [architecture review](https://gitlab.com/phpboyscout/afmpeg/-/wikis/external-review/architecture-review) | The consolidated report on perf, security, parity, and the dual-backend proposal |
